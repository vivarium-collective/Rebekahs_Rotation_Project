...
gut_models = {
        ...
        "E_rectale": "/Users/rebekahsheih/PycharmProjects/Rebekahs_Rotation_Project/Vivarium/cdFBA-main/Notebooks/sbml_mini/Eubacterium_rectale_ATCC_33656.xml"
    }
...
cobra.io.write_sbml_model(BT, "sbml (mini media)_mini/bt.xml")
bt_try = read_sbml_model("sbml_mini/bt.xml")
bt_try.optimize()
print(bt_try.summary())

cobra.io.write_sbml_model(ER, "sbml_mini/er.xml")
er_try = read_sbml_model("sbml_mini/er.xml")
er_try.optimize()
